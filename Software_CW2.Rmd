...
... how season, meteorological factors and more affect the number of bicycle rentals in two cities; Seoul, South Korea, and Washington D.C., USA by an
...
Figure X shows that the three meteorological factors selected as independent variables exhibit strong multicollinearity, meaning the assumption of independence between variables isn't shown in the data, which may negatively effect the accuracy and validity of the model for Seoul.
