...
Figure \ref{fig:fig2} shows the impact of Seoul's colder winters on bike rentals. The bike rentals in winter are noticeably lower than those in Washington D.C., when compared to the other seasons.
...
```{r fig4, fig.width=4,fig.height=4,fig.cap="\\label{fig:fig4} Bike rentals in Seoul and Washington D.C.", message=FALSE, fig.align='center', echo=FALSE}
...
```{r fig7, fig.width=5,fig.height=3,fig.cap="\\label{fig:fig7} Seoul normal Q-Q plot", message=FALSE, fig.align='center', echo=FALSE}
qqnorm(kr_resid)
```

```{r fig8, fig.width=5,fig.height=3,fig.cap="\\label{fig:fig8} Washington D.C. normal Q-Q plot", message=FALSE, fig.align='center', echo=FALSE}
qqnorm(dc_resid)
```
...
```{r fig10, fig.width=5,fig.height=3,fig.cap="\\label{fig:fig10} Washington D.C. scatterplot matrix", message=FALSE, fig.align='center', echo=FALSE}
